...
class MMDBoneOrderMenu(bpy.types.Menu):
    ...
    def draw(self, _context):
        layout = self.layout
        layout.operator("mmd_tools_local.fix_bone_order", text="Fix Bone Order", icon="LINENUMBERS_ON")
...
class MMDBoneOrder(PT_ProductionPanelBase, bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        # tb.separator()
        tb1 = tb.column(align=True)
        tb1.operator("mmd_tools_local.bone_id_move_top", text="", icon="TRIA_UP_BAR")
        tb1.operator("mmd_tools_local.bone_id_move_up", text="", icon="TRIA_UP")
        tb1.operator("mmd_tools_local.bone_id_move_down", text="", icon="TRIA_DOWN")
        tb1.operator("mmd_tools_local.bone_id_move_bottom", text="", icon="TRIA_DOWN_BAR")
        ...
        row.operator("mmd_tools_local.fix_bone_order", text="Fix Bone Order", icon="LINENUMBERS_ON")
